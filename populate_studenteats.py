...
def populate():
    ...
    Recipes = [
        ...
        {   'Recipe_ID':5, 
            'Title':'Pizza Bagels', 
            'Content': 'Heat oven to 425°F. \n\nSpread 1 tablespoon pizza sauce over each bagel half. \n\nSprinkle each with cheese and desired topping. Place on ungreased cookie sheet. \n\nBake 5 to 10 minutes or until cheese is melted.',
        ...
        {   'Recipe_ID':6, 
            'Title':'Cupcakes', 
            'Content': 'Using an electric whisk beat 110g softened butter and 110g golden caster sugar together until pale and fluffy then whisk in 2 large eggs, one at a time, scraping down the sides of the bowl after each addition. \nAdd ½ tsp vanilla extract, 110g self-raising flour and a pinch of salt, whisk until just combined then spoon the mixture into the cupcake cases. \n\nBake for 15 mins until golden brown and a skewer inserted into the middle of each cake comes out clean. \n\nLeave to cool completely on a wire rack.',
            'Tags': 'Dessert, Cake', 
            'Cuisine': 'Dessert', 
